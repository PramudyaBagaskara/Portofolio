                    ...
                    <div class="card-body">
                        <form action="{{ route('edit1') }}" method="Post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="formGroupExampleInput" placeholder="" value="{{ $data->judul }}" name="judul">
                            </div>
                            <div class="form-group">
                                <label for="exampleFormControlTextarea1">Description</label>
                                <textarea class="form-control description" id="exampleFormControlTextarea1"
                                    placeholder="Description" name="desc" rows="3">{{ $data->desc }}</textarea>
                            </div>
                            <input type="hidden" name="id_kategori" value="1">
                            <div class="form-group">
                                <label for="formGroupExampleInput">Author</label>
                                <input type="text" class="form-control" id="formGroupExampleInput" value="{{ $data->author }}" placeholder="Author"
                                    name="author">
                            </div>
                            <div class="form-group">
