        ...
        <header class="blog-header py-3">
            <div class="row flex-nowrap justify-content-between align-items-center">
                ...
                <div class="col-4 text-center">
                    <a class="blog-header-logo text-dark" style="font-family: 'Quicksand', sans-serif;" href="#">Article</a>
                </div>
        ...
        <div class="row">
            ...
            <div class="card" style="margin-bottom:30px;">
                    <div class="card-body">
                        ...
                        <img src="{{ asset('image/'.$g->foto) }}" class="" alt="" style="width:50%; margin-bottom:2%;" >
                        
                        <h6 style="margin-bottom:30px; font-family: 'Quicksand', sans-serif; margin-top:20px;">{!! str_limit($g->desc, 180) !!}</h6>
